...
<div class="top-menu">
	...
	<div class="pull-right">
    	<ul>
            <li><span>GAIN/LOSS</span> <a href="" class="btn btn-success btn-xs"><?php if($gain_loss != ''){ echo '$ '.$gain_loss; }else{ echo '$ 0.00';} ?></a></li>
            <li><span>INVESTED</span> <a href="" class="btn btn-success btn-xs"><?php if($invested != ''){ echo '$ '.$invested; }else{ echo '$ 0.00';} ?></a></li>
            <li><span>AVAILABLE</span> <a href="" class="btn btn-danger btn-xs"><?php if($balance != ''){ echo '$ '.$balance; }else{ echo '$ 0.00';} ?></a></li>
