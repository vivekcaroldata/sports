...
<div class="Predictions">
	<div class="container">    	
    	<h3 class="heading">~ The Prediction Market for Politics ~</h3>
...
<div class="slider margintop15">
	<div class="container">    
    	<h1 class="heading">~  Sports Swaps in the News  ~</h1>
      ...
      <div class="carousel slide media-carousel" id="media">
        <div class="carousel-inner">
          <div class="item  active">
            <div class="row">
              <div class="col-sm-2">
                <a class="thumbnail" href="#"><img alt="" src="<?php echo base_url(); ?>img/plogo.png"></a>
              </div>          
              <div class="col-sm-2">
                <a class="thumbnail" href="#"><img alt="" src="<?php echo base_url(); ?>img/plogo1.png"></a>
              </div>
              <div class="col-sm-2">
                <a class="thumbnail" href="#"><img alt="" src="<?php echo base_url(); ?>img/plogo2.png"></a>
              </div>      
              <div class="col-sm-2">
                <a class="thumbnail" href="#"><img alt="" src="<?php echo base_url(); ?>img/plogo3.png"></a>
              </div>          
              <div class="col-sm-2">
                <a class="thumbnail" href="#"><img alt="" src="<?php echo base_url(); ?>img/plogo4.png"></a>
              </div>
              <div class="col-sm-2">
                <a class="thumbnail" href="#"><img alt="" src="<?php echo base_url(); ?>img/plogo5.png"></a>
              </div>        
            </div>
          </div>
          <div class="item">
