...
class Sports {
	...
	public function  do_matched_deals($option_id,$type,$deal_type,$share_count,$rate)
	{
		...
		{
			$primaryArr['offered_by']   =  1; //$this->CI->session->userdata('id');            
			...
			$secondryArr['offered_by']   =  1; //$this->CI->session->userdata('id');            
	...
	public function new_offer_submit($primaryArr,$secondryArr)
	{
